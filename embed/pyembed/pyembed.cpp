...
void pyembed::Python::run_string(const std::string& s)
    throw (pyembed::Python_exception)
{
...
void pyembed::Python::run_file(const std::string& f)
    throw (pyembed::Python_exception)
{
...
void pyembed::Python::load(const std::string& module_name)
    throw (pyembed::Python_exception)
{
...
void pyembed::Python::call(const std::string& func_name)			       
    throw (pyembed::Python_exception)
{
    Arg_map args;
...
PyObject* pyembed::Python::get_function_object(const std::string& func_name)
    throw (pyembed::Python_exception)
{
    if (!module)
...
PyObject* pyembed::Python::create_args(const Arg_map& args)
    throw (pyembed::Python_exception)
{
    if (!module)
        throw Python_exception("No module loaded.");
...
void raise_func_failed_exception(const std::string& func_name)
    throw (pyembed::Python_exception)
{
    std::ostringstream oss;
...
void make_list_from_tuple(PyObject* tuple, pyembed::String_list& out)
{
    if (tuple)
    {
...
void make_list_from_list(PyObject* list, pyembed::String_list& out)
{
    if (list)
    {
...
void make_map_from_dict(PyObject* dict, pyembed::String_map& out)
{
    if (dict)
    {
        PyObject* key;
